...
namespace Learning.Data
{
    public interface ILearningRepository
    {
        ...
        IQueryable<Course> GetCourseBySubjectId(int subjectId);
        IQueryable<Course> GetAllCourses();
        Course GetCourse(int courseId, bool includeEnrollements = true);
        bool CourseExists(int courseId);

        IQueryable<Student> GetAllStudentWithEnrollments();
