...
namespace FoursquareAngularJS.Data
{
    ...
    public class FourSquareRepository:IFourSquareRepository
    {
        ...
        {
            return _ctx.BookmarkedPlaces.Where(x=>x.UserName==userName).AsQueryable();
        }
        ...
        {
            try {
                if (_ctx.BookmarkedPlaces.Any(b => b.UserName == bookmarkedPlace.UserName && b.VenueID == bookmarkedPlace.VenueID))
                {
                    return -1;
                }
